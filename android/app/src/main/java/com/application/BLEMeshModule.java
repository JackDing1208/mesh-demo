...
public class BLEMeshModule extends ReactContextBaseJavaModule implements LifecycleEventListener {
    ...
    // callback count - avoid the react-native callback be called multiple times
    int count = 0;
    int callback_count_provision = 0;
    int callback_count_bindApplicationKey = 0;
    ...
    public void removeNetworkKey(String key, Callback callback) {
        MeshSDK.INSTANCE.removeNetworkKey(key, new IntCallback() {
            @Override
